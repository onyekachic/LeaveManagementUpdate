...
namespace LeaveManagement.Persistence.Migrations
{
    ...
    [Migration("20231129211230_addedmoreAuditFields")]
            ...
            modelBuilder.Entity("LeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 11, 29, 21, 12, 29, 828, DateTimeKind.Local).AddTicks(3409),
                            DateModified = new DateTime(2023, 11, 29, 21, 12, 29, 828, DateTimeKind.Local).AddTicks(3478),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
